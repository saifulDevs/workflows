...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // workflowplify variable handling - safely convert any format to the object we need
...
2. If you're on a login page but don't see a username/password form, try scrolling or looking for "Continue with email" or workflowilar options.
