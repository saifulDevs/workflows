...
description: Learn how connections work in workflow Studio
---
...
Connections are the pathways that allow data to flow between blocks in your workflow. When you connect two blocks in workflow Studio, you're establishing a data flow relationship that defines how information passes from one block to another.
