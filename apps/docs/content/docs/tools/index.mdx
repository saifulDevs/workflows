...
Tools are powerful components in workflow Studio that allow your workflows to interact with external services, process data, and perform specialized tasks. They extend the capabilities of your agents and workflows by providing access to various APIs and services.
...
There are two primary ways to use tools in your workflow Studio workflows:
...
workflow Studio provides a diverse collection of tools for various purposes, including:
