...
description: Understanding workflow logs and how execution costs are calculated in workflow Studio
---
...
workflow Studio provides comprehensive logging for workflow executions and automatic cost calculation for AI model usage.

## Logging System

workflow Studio offers two complementary logging interfaces:
...
workflow Studio automatically calculates costs for all AI model usage:
...
<Tabs items={['Hosted Models', 'Bring Your Own API Key']}>
  <Tab>
    **Hosted Models** - workflow Studio provides API keys with a 2.5x pricing multiplier:
...
<Accordions>
  <Accordion title="Model Selection">
    Choose models based on task complexity. workflowple tasks can use GPT-4.1-nano ($0.10/$0.40) while complex reasoning might need o1 or Claude Opus.
  </Accordion>
