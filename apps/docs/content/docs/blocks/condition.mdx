...
<div className="mb-4 rounded-md border p-4">
  ...
  <ol className="list-decimal pl-5 text-sm">
    ...
    <li>Individual users → workflowple onboarding workflow</li>
  </ol>
</div>
...
- **Keep expressions workflowple**: Use clear, straightforward boolean expressions for better readability and easier debugging
