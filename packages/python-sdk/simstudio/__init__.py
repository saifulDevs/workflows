"""
workflow Studio SDK for Python

Official Python SDK for workflow Studio, allowing you to execute workflows programmatically.
"""
...
__version__ = "0.1.0"
__all__ = ["workflowsClient", "workflowsError", "WorkflowExecutionResult", "WorkflowStatus"]
...
class workflowsError(Exception):
    """Exception raised for workflow Studio API errors."""
...
class workflowsClient:
    """
    workflow Studio API client for executing workflows programmatically.
    
    Args:
        api_key: Your workflow Studio API key
        base_url: Base URL for the workflow Studio API (defaults to https://workflows.ai)
    """
    
    def __init__(self, api_key: str, base_url: str = "https://workflows.ai"):
    ...
    def execute_workflow(
        ...
        Raises:
            workflowsError: If the workflow execution fails
        """
        ...
        try:
            ...
            if not response.ok:
                ...
                raise workflowsError(error_message, error_code, response.status_code)
            ...
            raise workflowsError(f'Workflow execution timed out after {timeout} seconds', 'TIMEOUT')
        except requests.RequestException as e:
            raise workflowsError(f'Failed to execute workflow: {str(e)}', 'EXECUTION_ERROR')
    ...
    def get_workflow_status(self, workflow_id: str) -> WorkflowStatus:
        ...
        Raises:
            workflowsError: If getting the status fails
        """
        ...
        try:
            ...
            raise workflowsError(f'Failed to get workflow status: {str(e)}', 'STATUS_ERROR')
