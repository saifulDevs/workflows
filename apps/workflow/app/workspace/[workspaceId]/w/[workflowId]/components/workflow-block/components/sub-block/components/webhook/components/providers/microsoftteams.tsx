...
const teamsWebhookExample = JSON.stringify(
  {
    ...
    text: 'Hello workflow Studio Bot!',
  },
  null,
  2
)
  ...
  return (
    <div className='space-y-4'>
      ...
      <InstructionsSection
        ...
        tip='Create an outgoing webhook in Teams to receive messages from Teams in workflow Studio.'
      >
        <ol className='list-inside list-decimal space-y-1'>
          ...
          <li>Set the callback URL to your workflow Studio webhook URL (shown above).</li>
      ...
      <InstructionsSection title='Receiving Messages from Teams'>
        <p>
          ...
          to your workflow Studio webhook URL with a payload like this:
        </p>
      ...
      <Alert>
        ...
        <AlertDescription>
          <ul className='mt-1 list-outside list-disc space-y-1 pl-4'>
            <li>Your workflow Studio webhook URL must use HTTPS and be publicly accessible.</li>
