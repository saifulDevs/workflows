            ...
            <div className='space-y-8 text-white/80'>
              <section>
                ...
                <p>
                  ...
                  and shared when you visit or use workflow Studio ("the Service", "we", "us", or "our").
                </p>
                <p className='mt-4'>
              ...
              <section>
                ...
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]'>
                  ...
                  <li>
                    ...
                    Company", "We", "Us" or "Our" in this Agreement) refers to workflow Studio. For the
                  ...
                  <li>
                    <span className='text-[#B5A1D4]'>Website</span> refers to workflow Studio, accessible
                    from workflows.ai
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className='mb-4'>
                  We use cookies and workflowilar tracking technologies to track the activity on our
              ...
              <section>
                ...
                <p className='mb-4'>
                  workflow Studio may disclose your Personal Information in the good faith belief that
                  such action is necessary to:
                </p>
                <ul className='list-disc space-y-2 pl-6 marker:text-[#B5A1D4]'>
                  <li>To comply with a legal obligation</li>
                  <li>To protect and defend the rights or property of workflow Studio</li>
                  <li>
              ...
              <section>
                ...
                <p className='mb-4'>
                  workflow Studio's use and transfer to any other app of information received from Google
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  protection rights. workflow Studio aims to take reasonable steps to allow you to
                ...
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]'>
                  ...
                  <li>
                    ...
                    at any time where workflow Studio relied on your consent to process your personal
                    information.
                  </li>
                </ul>
                <p className='mb-4'>
              ...
              <section>
                ...
                <p className='mb-4'>
                  workflow Studio is dedicated to preserving data security by preventing unauthorized
                ...
                <p className='mb-4'>
                  ...
                  workflow Studio will not suggest or pursue legal action in connection with your study.
                </p>
                ...
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]'>
                  <li>workflows.ai website</li>
                  <li>workflow Studio web application</li>
                  <li>workflow Studio API services</li>
                </ul>
                <p className='mb-4'>
                  ...
                  third-party solutions workflow Studio interacts with are not covered by this policy and
                  ...
                  <Link
                    href='mailto:security@workflows.ai'
                    className='text-[#B5A1D4] hover:text-[#701ffc]'
                  >
                    security@workflows.ai
                  </Link>{' '}
              ...
              <section>
                ...
                <p>
                  ...
                  <Link
                    href='mailto:privacy@workflows.ai'
                    className='text-[#B5A1D4] hover:text-[#701ffc]'
                  >
                    privacy@workflows.ai
                  </Link>
                </p>
              </section>
            </div>
