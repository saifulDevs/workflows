...
export const EmailFooter = ({
  baseUrl = env.NEXT_PUBLIC_APP_URL || 'https://workflows.ai',
  unsubscribe,
}: EmailFooterProps) => {
  return (
    <Container>
        ...
        <table style={{ width: '100%' }}>
          ...
          <tr>
            <td align='center' style={{ paddingTop: '12px' }}>
              ...
              >
                © {new Date().getFullYear()} workflow Studio, All Rights Reserved
                <br />
                If you have any questions, please contact us at{' '}
                <a
                  href='mailto:help@workflows.ai'
                  style={{
                      ...
                      <a
                        href={
                          unsubscribe?.unsubscribeToken && unsubscribe?.email
                            ...
                            : `mailto:help@workflows.ai?subject=Unsubscribe%20Request&body=Please%20unsubscribe%20me%20from%20all%20emails.`
                        }
                        style={{
                          color: '#706a7b !important',
                          textDecoration: 'underline',
