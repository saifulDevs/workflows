    ...
    >
      ...
      <div className='flex w-full flex-col gap-12 md:grid md:grid-cols-2 md:grid-rows-1 lg:grid-cols-3'>
        ...
        >
          <BlogCard
            href='/blog/test'
            title='How to Build an Agent in 5 Steps with workflows.ai'
            description="Learn how to create a fully functional AI agent using workflows.ai's unified API and workflows."
            date={new Date('25 April 2025')}
            author='Emir Ayaz'
            authorRole='Designer'
            avatar='/static/workflow.png'
            type='Agents'
            readTime='6'
          />
          <BlogCard
