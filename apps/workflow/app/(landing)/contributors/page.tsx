        ...
        <section className='px-4 pt-20 pb-12 sm:px-8 sm:pt-28 sm:pb-16 md:px-16 md:pt-40 md:pb-24 lg:px-28 xl:px-32'>
          <div className='mx-auto max-w-6xl'>
            ...
            <div className='mb-12 text-center sm:mb-16'>
              ...
              >
                Meet the amazing people who have helped build and improve workflow Studio
              </motion.p>
            </div>
              ...
              <div className='mb-6 flex flex-col items-start justify-between gap-3 sm:mb-8 sm:flex-row sm:items-center sm:gap-4'>
                <div className='space-y-1'>
                  <div className='flex items-center gap-2'>
                    ...
                    <h2 className='font-semibold text-lg text-white sm:text-xl'>workflow Studio</h2>
                  </div>
                ...
                <div className='flex gap-2 self-end sm:self-auto'>
                  ...
                  >
                    <a href='https://github.com/workflowsai/workflow' target='_blank' rel='noopener'>
              ...
              <div className='relative p-6 sm:p-8 md:p-12 lg:p-16'>
                <div className='text-center'>
                  ...
                  <div className='mt-6 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:flex-wrap sm:justify-center sm:gap-4'>
                    ...
                    >
                      <a
                        href='https://github.com/workflowsai/workflow/blob/main/.github/CONTRIBUTING.md'
                        target='_blank'
                        rel='noopener'
                      >
                    ...
                    >
                      <a
                        href='https://github.com/workflowsai/workflow/issues'
                        target='_blank'
                        rel='noopener'
                      >
