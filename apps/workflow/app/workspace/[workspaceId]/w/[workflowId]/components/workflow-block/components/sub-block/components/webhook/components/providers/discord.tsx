...
const examplePayload = JSON.stringify(
  {
    content: 'Hello from workflow Studio!',
  ...
  return (
    <div className='space-y-4'>
      <ConfigSection title='Discord Appearance (Optional)'>
        ...
        >
          <Input
            ...
            placeholder='workflow Studio Bot'
      ...
      <Alert>
        ...
        <AlertDescription>
          The workflow Studio Webhook URL allows sending messages <i>to</i> Discord. Treat it like a
