  ...
  return (
    <Html>
      ...
      <Body style={baseStyles.main}>
        <Preview>You've been invited to join {organizationName} on workflow Studio</Preview>
        <Container style={baseStyles.container}>
          ...
          <Section style={baseStyles.content}>
            ...
            <Text style={baseStyles.paragraph}>
              ...
              <strong>{organizationName}</strong> on workflow Studio. workflow Studio is a powerful,
            ...
            >
              ...
              an invitation to join {organizationName} on workflow Studio.
            </Text>
          </Section>
        </Container>
