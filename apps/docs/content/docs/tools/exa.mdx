...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `url` | string | Yes | The URL to find workflowilar links for |
| `numResults` | number | No | Number of workflowilar links to return \(default: 10, max: 25\) |
| `text` | boolean | No | Whether to include the full text of the workflowilar pages |
| `apiKey` | string | Yes | Exa AI API Key |
...
| `workflowilarLinks` | json | workflowilarLinks output from the block |
