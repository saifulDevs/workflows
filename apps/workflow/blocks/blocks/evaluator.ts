...
// workflowplified response format generator that matches the agent block schema structure
...
export const EvaluatorBlock: BlockConfig<EvaluatorResponse> = {
  ...
  docsLink: 'https://docs.workflows.ai/blocks/evaluator',
  category: 'tools',
  bgColor: '#4D5FFF',
  icon: ChartBarIcon,
  subBlocks: [
    ...
    },
    {
      ...
      value: (params: Record<string, any>) => {
        try {
          ...
          // Create a clean, workflowple JSON object
          const result = {
