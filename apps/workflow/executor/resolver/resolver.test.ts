...
describe('InputResolver', () => {
  ...
  describe('Conditional Input Filtering', () => {
    ...
    it('should include all inputs when no conditions are present', () => {
      ...
      const workflowpleBlock: SerializedBlock = {
        id: 'workflowple-block',
        metadata: { id: 'workflowple-block', name: 'workflowple Block' },
        position: { x: 0, y: 0 },
        config: {
          tool: 'workflowple-block',
          params: {
            param1: 'value1',
            param2: 'value2',
          },
      ...
      const result = resolver.resolveInputs(workflowpleBlock, mockContext)
