...
Variables in workflow Studio act as a global store for data that can be accessed and modified by any block in your workflow. They provide a powerful way to share information between different parts of your workflow, maintain state, and create more dynamic applications.
...
Variables can be accessed from any block in your workflow using the variable dropdown. workflowply:
...
Variables in workflow Studio can store various types of data:
...
Variables in workflow Studio have global scope, meaning:
