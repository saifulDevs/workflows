...
This directory contains scripts to automatically generate documentation for all blocks in the workflow Studio platform.
...
1. Scans the `apps/workflow/blocks/blocks/` directory for all block definition files
