...
import { getworkflowplifiedBillingSummary } from '@/lib/billing/core/billing'
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (context === 'user') {
      ...
      billingData = await getworkflowplifiedBillingSummary(session.user.id, contextId || undefined)
    } else {
