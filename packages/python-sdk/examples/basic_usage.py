#!/usr/bin/env python3
"""
Basic usage examples for the workflow Studio Python SDK
"""
...
if __name__ == "__main__":
    print("🚀 Running workflow Studio Python SDK Examples\n")
    
    # Check if API key is set
    if not os.getenv("workflows_API_KEY"):
        print("❌ Please set workflows_API_KEY environment variable")
        exit(1)
