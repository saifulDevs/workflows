...
description: Complete guide to writing YAML workflows in workflow Studio
---
...
YAML workflows provide a powerful way to define, version, and share workflow configurations in workflow Studio. This reference guide covers the complete YAML syntax, block schemas, and best practices for creating robust workflows.

## Quick Start

Every workflow Studio workflow follows this basic structure:
...
workflow Studio supports several core block types, each with specific YAML schemas:
