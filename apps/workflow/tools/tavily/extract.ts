...
export const extractTool: ToolConfig<TavilyExtractParams, TavilyExtractResponse> = {
  ...
  name: 'Tavily Extract',
  description:
    "Extract raw content from multiple web pages workflowultaneously using Tavily's extraction API. Supports basic and advanced extraction depths with detailed error reporting for failed URLs.",
  version: '1.0.0',
