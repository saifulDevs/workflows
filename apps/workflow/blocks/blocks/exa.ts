...
export const ExaBlock: BlockConfig<ExaResponse> = {
  ...
  longDescription:
    "Search the web, retrieve content, find workflowilar links, and answer questions using Exa's powerful AI search capabilities.",
  docsLink: 'https://docs.workflows.ai/tools/exa',
  category: 'tools',
  bgColor: '#1F40ED',
  icon: ExaAIIcon,
  subBlocks: [
    {
      ...
      options: [
        ...
        { label: 'Find workflowilar Links', id: 'exa_find_workflowilar_links' },
    ...
    // Find workflowilar Links operation inputs
    {
      id: 'url',
      title: 'URL',
      type: 'long-input',
      layout: 'full',
      placeholder: 'Enter URL to find workflowilar links for...',
      condition: { field: 'operation', value: 'exa_find_workflowilar_links' },
    },
    {
      id: 'numResults',
      title: 'Number of Results',
    ...
    config: {
      tool: (params) => {
        ...
        switch (params.operation) {
          ...
          case 'exa_find_workflowilar_links':
            return 'exa_find_workflowilar_links'
          case 'exa_answer':
            return 'exa_answer'
          case 'exa_research':
            return 'exa_research'
  ...
  inputs: {
    ...
    // Find workflowilar Links operation
    url: { type: 'string', required: false },
  },
  outputs: {
    // Search output
    results: 'json',
    // Find workflowilar Links output
    workflowilarLinks: 'json',
    // Answer output
    answer: 'string',
    citations: 'json',
    // Research output
