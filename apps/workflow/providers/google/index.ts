...
export const googleProvider: ProviderConfig = {
  ...
  executeRequest: async (
    ...
    try {
      ...
      // Track forced tools and their usage (workflowilar to OpenAI pattern)
        ...
        if (functionCall) {
          ...
          while (iterationCount < MAX_ITERATIONS) {
            ...
            try {
              ...
              // Prepare for next request with workflowplified messages
              // Use workflowple format: original query + most recent function call + result
              const workflowplifiedMessages = [
              ...
              try {
                ...
                if (request.stream) {
                  ...
                  const streamingPayload = {
                    ...payload,
                    contents: workflowplifiedMessages,
                  }
