...
The workflowplest way to access data is through direct references using connection tags:

<Files>
  <File name="workflowple Property" annotation="<block.content>" />
