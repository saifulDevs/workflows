          ...
          <CardContent className='space-y-4'>
            ...
            <div className='mt-6 flex flex-col gap-3'>
              <Button
                onClick={() =>
                  window.open(
                    'mailto:help@workflows.ai?subject=Unsubscribe%20Help&body=Hi%2C%20I%20need%20help%20unsubscribing%20from%20emails.%20My%20unsubscribe%20link%20is%20not%20working.',
                    '_blank'
                  )
                }
            ...
            <div className='mt-4 text-center'>
              <p className='text-muted-foreground text-xs'>
                ...
                <a href='mailto:help@workflows.ai' className='text-primary hover:underline'>
                  help@workflows.ai
                </a>
              </p>
            </div>
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='mt-6 flex flex-col gap-3'>
              <Button
                onClick={() =>
                  window.open(
                    'mailto:help@workflows.ai?subject=Account%20Help&body=Hi%2C%20I%20need%20help%20with%20my%20account%20emails.',
                    '_blank'
                  )
                }
      ...
      <Card className='w-full max-w-md border shadow-sm'>
        <CardHeader className='text-center'>
          ...
          <CardDescription className='text-muted-foreground'>
            ...
            stop receiving from workflow Studio.
          </CardDescription>
