...
export const PineconeBlock: BlockConfig<PineconeResponse> = {
  ...
  longDescription:
    "Store, search, and retrieve vector embeddings using Pinecone's specialized vector database. Generate embeddings from text and perform semantic workflowilarity searches with customizable filtering options.",
  docsLink: 'https://docs.workflows.ai/tools/pinecone',
  category: 'tools',
  bgColor: '#0D1117',
  icon: PineconeIcon,
