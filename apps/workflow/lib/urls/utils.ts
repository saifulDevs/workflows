 ...
 * @returns The domain with port if applicable (e.g., 'localhost:3000' or 'workflows.ai')
 */
export function getBaseDomain(): string {
  try {
    ...
    try {
      ...
      return isProd ? 'workflows.ai' : 'localhost:3000'
    }
  }
}
 ...
 * @returns The email domain (e.g., 'workflows.ai' instead of 'www.workflows.ai')
 */
