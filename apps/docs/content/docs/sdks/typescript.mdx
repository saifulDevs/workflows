...
description: The official TypeScript/JavaScript SDK for workflow Studio
---
...
The official TypeScript/JavaScript SDK for workflow Studio allows you to execute workflows programmatically from your Node.js applications, web applications, and other JavaScript environments.
...
<Tabs items={['Development', 'Production']}>
  <Tab value="Development">
    ...
    if (!apiKey) {
      throw new Error('workflows_API_KEY environment variable is required');
    }
  ...
  <Tab value="Production">
    ...
    const client = new workflowsClient({
      apiKey,
      baseUrl: process.env.workflows_BASE_URL || 'https://workflows.ai'
    });
    ```
  </Tab>
</Tabs>
...
import { workflowsClient, WorkflowExecutionResult } from 'workflows-ts-sdk';

const client = new workflowsClient({
  apiKey: process.env.NEXT_PUBLIC_workflows_API_KEY!
});
