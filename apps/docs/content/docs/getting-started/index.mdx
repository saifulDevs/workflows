...
This tutorial will guide you through building your first AI workflow in workflow Studio. We'll create a people research agent that can find information about individuals using state-of-the-art LLM-Search tools.

<Callout type="info">
  This tutorial takes about 10 minutes and covers the essential concepts of building workflows in workflow Studio.
</Callout>
...
<Steps>
  <Step title="Create workflow and add AI agent">
    Open workflow Studio and click "New Workflow" in the dashboard. Name it "Getting Started".
