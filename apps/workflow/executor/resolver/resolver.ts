...
export class InputResolver {
  ...
  private formatValueForInterpolation(
    ...
    try {
      ...
      // Fallback to workflowple string conversion
      return String(value)
    }
  }
   ...
   * 2. An explicit env var with clear boundaries (usually within a URL or workflowilar)
   *
   ...
   * workflowilar to getLoopItems but for parallel blocks.
   *
