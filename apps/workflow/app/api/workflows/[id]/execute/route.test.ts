...
describe('Workflow Execution API Route', () => {
   ...
   * workflowulates direct execution with URL-based parameters
   */
   ...
   * workflowulates execution with a JSON body containing parameters
   */
  ...
  it('should execute workflow with empty request body', async () => {
    ...
    // Create params workflowilar to what Next.js would provide
    const params = Promise.resolve({ id: 'workflow-id' })
