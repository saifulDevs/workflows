...
export const embedding = pgTable(
  ...
  (table) => ({
    ...
    // Vector workflowilarity search indexes (HNSW) - optimized for small embeddings
    ...
    // Ensure embedding exists (workflowplified since we only support one model)
...
export const docsEmbeddings = pgTable(
  ...
  (table) => ({
    ...
    // Vector workflowilarity search indexes (HNSW) - optimized for documentation embeddings
