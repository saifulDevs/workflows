...
export async function POST(request: NextRequest) {
  try {
    ...
    const response: any = {
      ...
      note: 'This data represents only the blocks and configurations that the user has actually built in their current workflow, not all available workflow Studio capabilities.',
      yaml,
      format: 'yaml',
      summary: {
