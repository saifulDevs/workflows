          ...
          <div className='relative px-4 py-4 sm:px-8'>
            ...
            <div className='space-y-8 text-white/80'>
              <section>
                ...
                <p>
                  Please read these Terms of Service ("Terms") carefully before using the workflow Studio
                  platform (the "Service") operated by workflow Studio, Inc ("us", "we", or "our").
                </p>
                <p className='mt-4'>
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  remain the exclusive property of workflow Studio, Inc and its licensors. The Service is
                ...
                <p>
                  ...
                  service without the prior written consent of workflow Studio, Inc.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]'>
                  ...
                  <li>
                    ...
                    including any "junk mail", "chain letter," "spam," or any other workflowilar
                    solicitation.
                  </li>
                  <li>
                    To impersonate or attempt to impersonate workflow Studio, Inc, a workflow Studio employee,
                  ...
                  <li>
                    ...
                    enjoyment of the Service, or which, as determined by us, may harm workflow Studio,
              ...
              <section>
                ...
                <p>
                  ...
                  wish to terminate your account, you may workflowply discontinue using the Service.
                </p>
              </section>
              ...
              <section>
                ...
                <p className='mb-4'>
                  In no event shall workflow Studio, Inc, nor its directors, employees, partners, agents,
              ...
              <section>
                ...
                <p>
                  workflow Studio, Inc, its subsidiaries, affiliates, and its licensors do not warrant
                  that:
                </p>
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-[#B5A1D4]'>
                  <li>
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  arbitrate disputes with workflow Studio, Inc, its parent companies, subsidiaries,
                ...
                <p className='mb-4'>
                  ...
                  <Link
                    href='mailto:legal@workflows.ai'
              ...
              <section>
                ...
                <p>
                  ...
                  <Link
                    href='mailto:copyright@workflows.ai'
                    className='text-[#B5A1D4] hover:text-[#701ffc]'
                  >
                    copyright@workflows.ai
                  </Link>
                </p>
              </section>
