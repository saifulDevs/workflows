...
describe('HTTP Request Tool', () => {
  ...
  describe('Headers Construction', () => {
    ...
    test('should set dynamic Referer header correctly', async () => {
      ...
      Object.defineProperty(global, 'window', {
        value: {
          location: {
            origin: 'https://app.workflows.dev',
          },
        },
        writable: true,
      })
      ...
      // Setup mock response
      tester.setup(mockHttpResponses.workflowple)
      ...
      expect(fetchCall[1].headers.Referer).toBe('https://app.workflows.dev')
  ...
  describe('Request Execution', () => {
    test('should apply default and dynamic headers to requests', async () => {
      ...
      expect(headers.Referer).toBe('https://app.workflows.dev')
    ...
    test('should handle successful GET requests', async () => {
      ...
      expect(result.output.data).toEqual(mockHttpResponses.workflowple)
