...
export function ScheduleModal({
  ...
  // workflowpler approach - we'll use this to store the initial values when the modal opens
  ...
  // Track changes - workflowplified approach
  useEffect(() => {
    if (!isOpen) return
    ...
    // workflowple JSON comparison to detect any changes
